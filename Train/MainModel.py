...
def get_response(input_str: str):
    ...
    if input_str == "6的阶乘是多少？":
        ...
        res = "<|call|>[vilt-b32-finetuned-vqa](\"What is the color of the bed?\",10)<|end|>"
    else:
        assert False
...
if __name__ == "__main__":
    print(get_response("6的阶乘是多少？"))
    print(get_response("请生成一张大海的图片"))
    print(get_response("请概括这张图片的内容。"))
    print(get_response("床的颜色是什么"))
    exit(0)
